...
- slot 4:
    - [Control flow and user-defined functions](04_new2018/01_userDefinedFunctions.md)
        [[tasks](04_new2018/01_userDefinedFunctions.tasks.nocode.md)]
        [[solutions](04_new2018/01_userDefinedFunctions.tasks.code.md)] 

- slot 5:
    - [Character string processing & Pattern matching](06/character_strings.md)
        [[tasks](06/character_strings.tasks.nocode.md)]
        [[solutions](06/character_strings.tasks.code.md)]
    - [S3 and S4 classes](08/s3s4.md)
        [[tasks](08/s3s4.tasks.nocode.md)]
        [[solutions](08/s3s4.tasks.code.md)]
- slot 6:
    - [Making errors the right way](05.renee/03_makingErrors.md)
    - Reproducible research

<!-- - [Regression](07.2017/01_regression.md)
        [[tasks](07.2017/01_regression.tasks.nocode.md)]
        [[solutions](07.2017/01_regression.tasks.code.md)] 
    - [[Extra exercises](07.2017/02_plenty.tasks.nocode.md)]
        [[solutions](07.2017/02_plenty.tasks.code.md)] -->

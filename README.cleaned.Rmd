...
4. download the course materials [.zip file](`r params$RCourseURL`/R_course.zip) (see below) to your laptop. Unpack the zip file to a directory, and please check whether you can open `index.html` file from the directory.
...
- slot 4:
    - [R scripts and reports (Rmarkdown)](04_new2018/02_rmarkdown.html)
